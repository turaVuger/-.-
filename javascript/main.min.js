...
FormInfo.getFormTitle("search")+"' type='text' size='30' placeholder='"+FormInfo.getFormTitle("search")+"' value=''/></label></div>");this.isRightToLeft()?(this.edtPreSearch.find("input").attr("dir","rtl"),this.btnPreSearch.$button.addClass("left"),this.edtPreSearch.css({float:"right"})):this.btnPreSearch.$button.addClass("right");this.searchBar.append(this.edtPreSearch);this.btnPreSearch.addTo(this.searchBar);this.btnPreSearch.hint=!1;this.btnPreSearch.$button.asButton();this.btnPreSearch.changeColor(this.searchButtonColor.toString());
