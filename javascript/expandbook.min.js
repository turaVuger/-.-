...
this.side.attr("id",b+a);this.init(a)},init:function(a){isNaN(a)||(this.pages=$("<div class='slide_pages'></div>"),this.initPages(a),this.setPageCss(),this.side.append(this.pages),this.initEvent())},initEvent:function(){this.adContainer&&this.adContainer.css({"z-index":3});isBelowIE9()?this.pages.IEZoom({side:this,zoomIn:this.zoomIn.bind(this),zoomOut:this.zoomOut.bind(this),onZoomed:this.onZoomed.bind(this)}):this.pages.zoom({side:this,zoomIn:this.zoomIn.bind(this),zoomOut:this.zoomOut.bind(this),
onZoomed:this.onZoomed.bind(this)})},zoomIn:function(a){a=BookInfo.getBook();a.status_zoom=!0;a.adContainer&&a.adContainer.css({"z-index":1});StateSynchronous.instance().findButtons("ZoomButton",!0).each(function(c){c.setAsZoomout();c.executeCallback()});window.toolBar&&window.toolBar.btnZoom&&window.toolBar.changeZoomIcon(!1);if(!isPhone()&&!isPad()){this.switchLargeImage();bookConfig.ZoomToolbarVisible&&bookConfig.isZoomControlBarVisible&&!this.controlBar&&(this.controlBar=new ZoomControlBar(tmpContainer),
...
(this.leftPage&&(this.leftPage.setUpOrDown(!0),this.leftPage.setCSSByStyle(a)),this.rightPage&&(this.rightPage.setUpOrDown(!1),this.rightPage.setCSSByStyle(a)))},addPageArray:function(a){if(a&&this.pageArray)for(var b=0;b<a.length;b++)if(!(0>=a[b]||a[b]>originTotalPageCount||this.pageArray[a[b]])){var c=new Page(a[b],"page",this.bookType,this.onPageLoaded);c.hideMiddleShadow();c.onResize(this.pageWidth,this.pageHeight);this.pageArray[a[b]]=c;this.pages.append(c.side)}},fillContent:function(a){this.pageArray[a]&&
...
bookConfig.isZoomControlBarVisible&&!this.controlBar&&(this.controlBar=new ZoomControlBar(tmpContainer),this.controlBar.setPosition((windowWidth-this.controlBar.width)/2,templateArea.getTopHeight()+a+5));if(this.controlBar){var a="lite"==bookConfig.ToolbarViewMode&&bookType==BookType.catalog_book?50:0;this.controlBar.setPosition((windowWidth-this.controlBar.width)/2,templateArea.getTopHeight()+a+5);this.controlBar.setVisible(!0)}global.canMagnifierZoom&&this.unMagnifierZoom()},zoomOut:function(){this.status_zoom=
